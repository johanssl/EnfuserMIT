...
public final class Julian {
     ...
     *
     * @param fromJulianDate julian date computed with GregorianCalendar
     ...
     */
    public Julian(final double fromJulianDate, final double deltaT) {
     ...
     */
    public Julian(final GregorianCalendar date, final double deltaT) {
