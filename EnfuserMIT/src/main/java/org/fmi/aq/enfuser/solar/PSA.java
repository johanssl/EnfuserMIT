...
public final class PSA {
     ...
     *
     * @param date Note that it's unclear how well the algorithm performs before
     * the year 1990 or after the year 2015.
     ...
     */
    public static double[] calculateSolarPosition(final GregorianCalendar date, final double latitude, final double longitude) {
        ...
        // Calculate local coordinates ( azimuth and zenith angle ) in degrees
        {
            ...
            return new double[]{azimuth, zenithAngle};
        }
