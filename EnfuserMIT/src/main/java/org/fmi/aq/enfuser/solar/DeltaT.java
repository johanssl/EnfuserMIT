...
/**
 * Finding values for Delta T, the difference between Terrestrial Time (TT) and
 * Universal Time (UT1).
 */
public final class DeltaT {
    ...
    /**
     * Estimate Delta T for the given Calendar. This is based on Espenak and
     * Meeus, "Five Millennium Canon of Solar Eclipses: -1999 to +3000"
     * (NASA/TP-2006-214141).
     *
